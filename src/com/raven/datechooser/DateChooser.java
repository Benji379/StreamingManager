...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private final String MONTH_ENGLISH[] = {"Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Junio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"};
    ...
    private void execute() {
        setForeground(com.sm.modelo.SystemConfig.MAIN_COLOR_1);
    ...
    private void initComponents() {
        ...
        header.setBackground(com.sm.modelo.SystemConfig.MAIN_COLOR_1);
