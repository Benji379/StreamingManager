...
public class MessageError extends javax.swing.JPanel {

    public MessageError(String titulo, String descripcion) {
        initComponents();
        txtTituloMensaje.setText(titulo);
        txt.setText(descripcion);
        setOpaque(false);
        txt.setBackground(new Color(0, 0, 0, 0));
        txt.setSelectionColor(new Color(204, 0, 0));
        txt.setOpaque(false);
    }
    ...
    private void initComponents() {
        ...
        cmdOK.setBackground(new Color(153, 0, 0));
