...
import com.sm.controladores.CConfig;
import static com.sm.modelo.SystemConfig.*;

public class mdlConfig extends javax.swing.JPanel {

    CConfig controlador;

    public mdlConfig() {
        initComponents();
        controlador = new CConfig(this);
        controlador.init();
        initDesing();
    }
    ...
    private void initComponents() {
        ...
        pInputs.setBackground(new java.awt.Color(30, 30, 30));

        pAplicacion.setBackground(new java.awt.Color(30, 30, 30));
        ...
        txtAplicacion.setFont(new java.awt.Font("Century Gothic", 0, 16)); // NOI18N
        ...
        pInputsLayout.setHorizontalGroup(
            ...
            .addGroup(pInputsLayout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addGroup(pInputsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(pAplicacion, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void initDesing() {
        BACKGROUND1(this, pAplicacion, pBotones, pEstado, pInputs);
        BOTON1(btnActualizar, btnAgregar, btnCarpeta, btnDescargar, btnEliminar, btnLimpiar);
        TEXT1(jlbAplicacion, jlbEstado, jlbTitulo);
        TEXT2(btnActualizar, btnAgregar, btnCarpeta, btnDescargar, btnEliminar, btnLimpiar);
    }
