...
public class Carga200 extends com.sm.componet.PanelCustom {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sm/load/200.gif"))); // NOI18N

        imageAvatar1.setBorderSize(10);
        imageAvatar1.setBorderSpace(0);
        imageAvatar1.setGradientColor1(new java.awt.Color(0, 0, 0));
        imageAvatar1.setGradientColor2(com.sm.modelo.SystemConfig.MAIN_COLOR_1);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(imageAvatar1, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(jLabel1)
