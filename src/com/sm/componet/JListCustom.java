...
public class JListCustom {
    ...
    public static void customizeJList(JList<String> jList, int itemHeight, int itemSpacing, int leftSpacing, Color fondoColor, Color fondoResaltado, int formatoLetras) {
        // Crear un borde vacío
        Border emptyBorder = BorderFactory.createEmptyBorder();

        // Establecer el fondo blanco
        jList.setBackground(fondoColor);
        ...
        jList.setCellRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index,
                ...
                renderer.setBackground(isSelected ? fondoResaltado : fondoColor);
