...
public class Item extends JButton {
    ...
    private final Color mainColor = SystemConfig.MAIN_COLOR_2;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!mainMenu) {
            ...
            if (isSelected()) {
                Graphics2D g2 = (Graphics2D) g.create();
                g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                g2.setPaint(new GradientPaint(0, 3, SystemConfig.MAIN_COLOR_1, 3, getHeight() - 6, SystemConfig.MAIN_COLOR_2));
    ...
    public void setGoogleIcon(GoogleMaterialDesignIcon icon) {
        if (icon != null) {
            this.icon = icon;
            setIcon(new GoogleMaterialIcon(icon, GradientType.HORIZONTAL, SystemConfig.MAIN_COLOR_1, SystemConfig.MAIN_COLOR_2, 19).toIcon());
        }
    }
